...
const BookingItem = ({booking}: BookingItemProps) => {
  ...
  const isBookigConfirmed = isFuture(booking.date)
  ...
  return ( 
    <Sheet>
        ...
        <Card className="min-w-full">
          <CardContent className="py-0 flex px-0">
            <div className="flex flex-col gap-2 py-5 flex-[3] pl-3">
              <Badge variant={
                isBookigConfirmed ? "default" : "secondary"
              } className="w-fit">{isBookigConfirmed? "Confirmado" : "Finalizado"}</Badge>
      ...
      <SheetContent className="px-0">
        ...
        <div className="px-5">
          <div className="relative h-[188px] w-full mt-6">
          ...
          <Badge
            variant={isBookigConfirmed ? "default" : "secondary"}      className="w-fit my-3">
              {isBookigConfirmed? "Confirmado" : "Finalizado"}
          </Badge>
          ...
          <SheetFooter className="flex-row gap-3 mt-6">
            ...
            <Button disabled={!isBookigConfirmed || isDeleteLoading} variant="destructive" onClick={handleCancelClick}className="w-full">
